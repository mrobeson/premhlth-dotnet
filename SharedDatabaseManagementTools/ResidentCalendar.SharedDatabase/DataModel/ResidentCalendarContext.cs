...
namespace ResidentCalendar.SharedDatabase.DataModel
{
    public class ResidentCalendarContext : DbContext
    {
    ...
    public class TestResidentCalendarContext : DropCreateDatabaseAlways<ResidentCalendarContext>
    {
       // protected override void Seed(ResidentCalendarContext context)
       // {
       //     // Add Schedule
